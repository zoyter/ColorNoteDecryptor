# This file based on https://github.com/fcoiffie/decode-ColorNote
...
def DecryptColorNote(bakfile,all_data):
	...
	open("notes.bin", "wb").write(decoded_doc)
	idx = 0x10
	...
	for n in notes.get():
		if not n.is_archived():
			all_data.append('--------')
			logging.debug(n)
			all_data.append(n.get_title())
			all_data.append("Создан: {}\t Изменён: {}".format(n.get_created_date(), n.get_modified_date()))
			all_data.append(n.get_note())